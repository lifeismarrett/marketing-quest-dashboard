...
| 기준 checkpoint | **최종 제출 기준 `6d003e4e`** — `b4293e70` 이후 GPT AUDIT 정정·PDF 재생성·공개 런타임 회귀 검증을 반영한 최신 checkpoint |
...
**Version control:** `4668a552`는 V2 evidence layer·발표자료를 저장한 이전 checkpoint, `b4293e70`은 그 위에 GPT용 HANDOFF를 저장한 이전 checkpoint입니다. `6d003e4e`는 그 후 GPT AUDIT 정정, V2 PDF 재생성, 공개 런타임 회귀 기록까지 반영한 최신 checkpoint이며 최종 제출 기준입니다.
